...
Future<void> showSuccessDialog(BuildContext context, String tip,
  ...
  showDialog(
    ...
    builder: (context) => tipDialog(Icon(Icons.check_circle, size: 24), tip),
  );
...
extension ProgressDialogExt<T> on Future<T> {
  ...
  Future<T> withSuccessDialog(BuildContext context, String tip) {
    return showProgressDialog(context, run: () async {
      final res = await this;
      await showSuccessDialog(context, tip, barrierTransparent: true);
      return res;
    });
  }
}
